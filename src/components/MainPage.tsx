    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen p-4 text-white font-sans">
      ...
      <div className="relative z-10 max-w-7xl px-4 mx-auto w-full py-6">
        <div className="flex justify-center mb-4">
          <img className="max-w-[120px] md:max-w-[177px] w-full" src={TopLogo} alt="top logo" />
        </div>

        <h1 className=" mb-9 mt-8 text-[35px] sm:text-[45px] md:text-[60px] poller text-center font-bold leading-[1]">
          WELCOME TO SOLADZ
        </h1>
        ...
        <p className="text-center text-base md:text-[20px]  leading-[1.3] mt-4 mb-[30px] md:mb-[50px] max-w-[645px] mx-auto">
          By Contributing To The Community Fund, You Will Get High Targeted Traffic Through The
          Advertising Network
        </p>

        <div className="flex items-center justify-center">
          <GradientButton text="Get Your Invitation Link" />
        </div>
